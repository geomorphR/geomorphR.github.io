...
There are multiple ways to compare allometric trajectories. First we will compare a trajectory to some *a priori* vector using `betaTest`. Then we will compare trajectories to each other. 
