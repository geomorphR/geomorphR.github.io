...
+ Let $\tilde{\mathbf{H}}_{reduced}$ be any model that serves as a null model for another alternative model.  It could be the null model or one that is lacking parameters compared to the alternative.
+ Let $\tilde{\mathbf{H}}_{full}$ be any model that is compared to a reduced model, having some parameters that the reduced model lacks.
