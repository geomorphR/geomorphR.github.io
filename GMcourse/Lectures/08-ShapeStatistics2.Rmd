...
.footnote[1. Mixed effects in a linear model are beyond the scope of this workshop, but we could probably help someone with such needs in lab time.]
---
...
With the pupfish data, we will briefly explore three such cases before leaving these for a more formal treatment in **Lecture 11 RRPP Extensions**.
...
Trajectory analysis and analysis of disparity will be discussed in more detail in **Lecture 11: RRPP Extensions**. 
