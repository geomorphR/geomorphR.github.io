...
### Let's pause for a moment and think about the process of alignment of data for linear models
...
$$\hat{\boldsymbol{\Sigma}}_{effect} = (k-1)^{-1}(\hat{\mathbf{Z}}^T_{alt}\hat{\mathbf{Z}}_{alt}  -\hat{\mathbf{Z}}^T_{null}\hat{\mathbf{Z}}_{null}),$$
...
where $\Delta\tilde{\mathbf{H}} = \tilde{\mathbf{H}}_{alt} - \tilde{\mathbf{H}}_{null}$.
