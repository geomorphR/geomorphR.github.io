...
+ RRPP is useful for providing $P$-values and $Z$-scores for **.blue[primary statistics]**, like $F$, $R^2$, $\lambda_{Roy}$, etc.
  + These may be typical test statistics or descriptive test statistics (like $R^2$) that can be used as test stistics.
  + They are calculated directly from $\mathbf{S}$ or $\hat{\boldsymbol{\Sigma}}$ matrices.
  
+ RRPP is rather essential for statistical evaluation of **.green[secondary statistics]**, which are statistics canulated from other statistics.  These involve contrasting variances, or contrasting differences between estimated values, or finding the angular differences between vectors that describe the differences between estimated values, plus other.
...
+ Think of the `pupfish` example.  
    ...
    + But what if we wish to entertain whether the difference in one population is the same as the difference in the other population.  We need to be able to contrast the differences (one statistic) in a secondar statistic.  ***Secondary statistics make use of primary statistics for better hypotheses.***
...
## Using RRPP to comapre attributes of shape change
...
.pull-right[
```{r, echo = FALSE}
include_graphics("LectureData/14.RRPPExtensions/IntroPCPlot.png")  
```
]
...
.pull-right[
```{r, echo = FALSE}
include_graphics("LectureData/14.RRPPExtensions/IntroPCPlot2.png")  
```
]
.pull-left[
...
```{r, echo = FALSE, out.width="50%"}
include_graphics("LectureData/14.RRPPExtensions/TradeOff.png")  
```
...
include_graphics("LectureData/14.RRPPExtensions/Interaction-UnivData.png")  
```
...
```{r, echo = FALSE, out.width="80%"}
include_graphics("LectureData/14.RRPPExtensions/Interaction-BivarData.png")  
```
...
.pull-left[
```{r, echo = FALSE}
include_graphics("LectureData/14.RRPPExtensions/pta3d.png")   
```
]
...
- 2) pseudo values are obtained as $\small\mathbf{\mathcal{Z}} = \mathbf{\hat{Y}}_{R} + \mathbf{\tilde{E}}_{R}^*$
...
.pull-right[
```{r, echo = FALSE}
include_graphics("LectureData/14.RRPPExtensions/pta/Slide02.png")   
```
]
...
include_graphics("LectureData/14.RRPPExtensions/TrajNoCov.png")   
```
...
```{r, echo = FALSE, fig.height=2}
include_graphics("LectureData/14.RRPPExtensions/TrajWithCov.png")   
```
...
include_graphics("LectureData/14.RRPPExtensions/pta.wcov.png")   
```
]
.pull-right[
...
```{r, echo = FALSE, out.width="80%"}
include_graphics("LectureData/14.RRPPExtensions/pta/Slide04.png")  
```
...
.center[
```{r, echo = FALSE, out.width="50%"}
include_graphics("LectureData/14.RRPPExtensions/pta/Slide05.png")  
```
]
---
...
.center[
```{r, echo = FALSE, out.width="50%"}
include_graphics("LectureData/14.RRPPExtensions/pta/Slide06.png")  
```
]
---
...
.center[
```{r, echo = FALSE, out.width="50%"}
include_graphics("LectureData/14.RRPPExtensions/pta/Slide07.Png")  
### Trajectory Analysis (Cont.)
```
]
---
...
include_graphics("LectureData/14.RRPPExtensions/pta/Slide08.png")  
```
...
```{r, echo = FALSE, out.width="70%"}
include_graphics("LectureData/14.RRPPExtensions/pta/Slide09.png")  
```
...
```{r, echo = FALSE, out.width="70%"}
include_graphics("LectureData/14.RRPPExtensions/pta/Slide10.png")  
```
...
```{r, echo = FALSE, out.width="70%"}
include_graphics("LectureData/14.RRPPExtensions/pta/Slide11.png")  
```
...
```{r, echo = FALSE, out.width="80%"}
include_graphics("LectureData/14.RRPPExtensions/pta/Slide12.png")  
```
...
```{r, echo = FALSE, out.width="70%"}
include_graphics("LectureData/14.RRPPExtensions/pta/Slide13.png")  
```
...
```{r, echo = FALSE, out.width="80%"}
include_graphics("LectureData/14.RRPPExtensions/snake.pta/Slide1.png")  
```
...
```{r, echo = FALSE, out.width="80%"}
include_graphics("LectureData/14.RRPPExtensions/snake.pta/Slide2.png")  
```
...
```{r, echo = FALSE, out.width="80%"}
include_graphics("LectureData/14.RRPPExtensions/snake.pta/Slide3.png")  
```
...
```{r, echo = FALSE, out.width="80%"}
include_graphics("LectureData/14.RRPPExtensions/snake.pta/Slide4.png")  
```
...
include_graphics("LectureData/14.RRPPExtensions/ta.examples/Slide1.png")  
```
...
```{r, echo = FALSE, out.width="100%"}
include_graphics("LectureData/14.RRPPExtensions/ta.examples/Slide2.png")  
```
...
```{r, echo = FALSE, out.width="100%"}
include_graphics("LectureData/14.RRPPExtensions/ta.examples/Slide3.png")  
```
...
```{r, echo = FALSE, out.width="100%"}
include_graphics("LectureData/14.RRPPExtensions/ta.examples/Slide4.png")  
```
...
```{r, echo = FALSE, out.width="100%"}
include_graphics("LectureData/14.RRPPExtensions/ta.examples/Slide5.png")  
```
...
```{r, echo = FALSE, out.width="100%"}
include_graphics("LectureData/14.RRPPExtensions/ta.examples/Slide6.png")  
```
...
```{r, echo = FALSE, out.width="100%"}
include_graphics("LectureData/14.RRPPExtensions/ta.examples/Slide7.png")  
```
...
```{r, echo = FALSE, out.width="100%"}
include_graphics("LectureData/14.RRPPExtensions/Bolnick.png")  
```
...
```{r, echo = FALSE, out.width="80%"}
include_graphics("LectureData//14.RRPPExtensions/eccentricity.png")  
``` 
---
### Disparity: Other descriptive statistics (Cont.)
