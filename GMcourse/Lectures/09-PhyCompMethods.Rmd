...
:----- | :----- | :----- | :----- | :----- 
$\small\hat{\mathbf\beta_F}$ | $\small\mathbf{X}_F\hat{\mathbf\beta}_F$ | $\small(\mathbf{Z}-\hat{\mathbf{Z}}_F)$ | $\small(\tilde{\mathbf{Z}} - \tilde{\mathbf{X}}_F\boldsymbol{\hat{\beta}}_F)$ | $\tilde{\mathbf{E}}_F^T \tilde{\mathbf{E}_F}$ 
$\small\hat{\mathbf\beta_R}$ | $\small\mathbf{X}_R\hat{\mathbf\beta}_R$ | $\small(\mathbf{Z}-\hat{\mathbf{Z}}_R)$ | $\small(\tilde{\mathbf{Z}} - \tilde{\mathbf{X}}_R\boldsymbol{\hat{\beta}}_R)$ | $\tilde{\mathbf{E}}_R^T \tilde{\mathbf{E}_R}$ 
