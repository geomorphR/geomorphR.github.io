...
+ Multivariate Phylogenetic Comparative Methods
  ...
  5. PCMs with multiple individuals per species
---
...
### 2B: Dimensions of Phylogenetic Signal

+ 100s of GMM (and other) studies have utilized $K_{mult}$: 

.pull-left[
```{r echo = FALSE, fig.align = "center", eval=TRUE,out.width="90%"}
include_graphics("LectureData/09.pcm/PhySigWeakHist.png")
```
...
```{r echo = FALSE, fig.align = "center", eval=TRUE,out.width="90%"}
include_graphics("LectureData/09.pcm/PhySigSimul.png")
```
...
---
### 2B: Dimensions of Phylogenetic Signal: Computations 
...
.footnote[1. Mitteroecker, Collyer, Adams. (2025). *Syst.Biol.*]
---
...
### 2B: Dimensions of Phylogenetic Signal: Example

+ Crocodylians display strong and concentrated phylogenetic signal 

.pull-left[
```{r echo = FALSE, fig.align = "center", eval=TRUE,out.width="90%"}
include_graphics("LectureData/09.pcm/CrocPhylo.png")
```
...
```{r echo = FALSE, fig.align = "center", eval=TRUE,out.width="90%"}
include_graphics("LectureData/09.pcm/CrocPhySigRes.png")
```
...
+ Skull evolution mirrors main dimension of phylogenetic signal

```{r echo = FALSE, fig.align = "center", eval=TRUE,out.width="70%"}
include_graphics("LectureData/09.pcm/CrocKPCARes.png")
```
...
### 5: E-PGLS: PCMs with Multiple Individuals
...
### 5: Extended Phylogenetic Least Squares (E-PGLS) $^1$
...
.footnote[1. Adams and Collyer (2024). *Methods Ecol. Evol*]
---
...
include_graphics("LectureData/09.pcm/ExpandedOmegaMatrix.png")
```
]
...
### 5: E-PGLS: Simulations

.pull-left[

```{r, echo=FALSE, out.width="90%", fig.cap= ""}
include_graphics("LectureData/09.pcm/Fig1.png")
```
...
include_graphics("LectureData/09.pcm/Fig2a.png")
include_graphics("LectureData/09.pcm/Fig2b.png")
```
...
### 5: E-PGLS: Example (pupfish SShD)


```{r, echo=FALSE, out.width="80%", fig.cap= ""}
include_graphics("LectureData/09.pcm/Fig3.png")
```

.footnote[1. Adams and Collyer (2024). *Methods Ecol. Evol*]

+ Enables within-species patterns to be compared across the phylogeny!
---
...
+ Hypotheses one can evaluate with shape data include:
  ...
  + PGLS for comparing within-species patterns (E-PGLS)
