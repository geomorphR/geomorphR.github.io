...
include_graphics("LectureData/09.pcm/MammalBS-HR.png", dpi = 300)  
```
]
.pull-right[
...
include_graphics("lectureData/09.pcm/PCM-Metab.png", dpi = 300)
...
.pull-right[
```{r, echo = FALSE, fig.align = "center",  out.width="90%"}
include_graphics("lectureData/09.pcm/PCM-PrimateCoev.png", dpi = 300)
