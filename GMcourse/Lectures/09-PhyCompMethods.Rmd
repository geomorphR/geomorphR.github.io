...
include_graphics("LectureData/09.pcm/MammalBS-HR.png", dpi = 100)  
```
]
.pull-right[
...
include_graphics("lectureData/09.pcm/PCM-Metab.png", dpi = 100)
...
.pull-right[
```{r, echo = FALSE, fig.align = "center",  out.width="90%"}
include_graphics("lectureData/09.pcm/PCM-PrimateCoev.png", dpi = 100)
...
include_graphics("LectureData/09.pcm/PhyloMorphoSpace.png", dpi = 100)  
```
