...
.footnote[Note: Fixed angle method of Adams (1999) generalized for 3D data in `shapeRotator`: Vidal-Garcia et al. (2018). *Ecol. Evol.*]
---
...
+ Scale each subset configuration by: $\frac{w_iCS_i}{\sqrt{\sum{w_i^2CS^2_i}}}$
