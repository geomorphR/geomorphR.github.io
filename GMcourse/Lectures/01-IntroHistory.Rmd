...
+ Development of morphometrics, evolutionary biology, and statistics are  intertwined

+ **Biometric Tradition** (late 1800s): viewed most biological variation as continuous
  + Galton, Pearson, Fisher, etc.: $\sigma^2$, $\rho$, $\chi^2$, $\beta$, etc.

--

+ $20^{th}$ century: development continued
  + Fisher, Wright, Rao, Spearman etc.: ANOVA, variance partitioning, Discriminant Analysis, Principal Components, multivariate T-tests, Path Analysis, etc.  

--

+ Analytical tools paved the way for multivariate morphometrics
  + Understanding *WHAT* to measure (and how) was less clear. This hampered meaningful biological inference!
